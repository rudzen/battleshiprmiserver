...
import args.intervals.Interval.EndpointMode;
 ...
 * <ol>
 * <li>If the intervals have differing lower endpoint values then the interval
 ...
 * value.</li>
 * <li>If the intervals have identical lower endpoint values but differing lower
 ...
 * <li>If the lower endpoints of the two intervals are equal, then the interval
 ...
 * other value.</li>
 * <li>If the lower endpoints of the two intervals are equal, and both have
 ...
 * <li>If the lower endpoints of the intervals are equal, and the upper
 * endpoints of the intervals are equal, then the two intervals are considered
...
public final class IntervalComparator<T extends Comparable<T>> implements
	 ...
	 * intervals of the specified basis type.
	 * <p>
	 * To get an <code>IntervalComparator</code> which compares intervals of
	 ...
	 * <var>o2</var>; or zero if the two intervals are comparatively identical;
	 ...
	 * <p>
	 * If both intervals have identical values and modes for their lower
	 * endpoint then zero is returned.</p>
	 * <p>
	 * If both intervals have identical values for their lower endpoint but
	 ...
	 * interval then a positive integer is returned.</p>
	 * <p>
	 * If both intervals have identical values and modes for their upper
	 * endpoint then zero is returned.</p>
	 * <p>
	 * If both intervals have identical values for their upper endpoint but
